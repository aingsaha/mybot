...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
        ...
        ////DAFTAR BUTTON 
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan Denara Bot Verify Terlebih Dahulu Ya `
...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `994400145499`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break
               case 'spamcall':{
...
Made With ❤️ in Banjarnegara,Indonesia
...
🐟 ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created Denara 𝐵𝑜𝑡𝑧☕`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @cal_me_Denara`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'denara 𝐵𝑜𝑡𝑧☕', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @cal_me_Denara`,buttons,headerType:4}
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                  ...
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${setting.lolkey}&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'denara 𝐵𝑜𝑡𝑧☕T', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @cal_me_Denara`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
reply (mess.wait)
             buff = await getBuffer(`https://leyscoders-api.herokuapp.com/api/${command}?apikey=IkyOgiwara`)
              ...
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Denara 𝐵𝑜𝑡𝑧☕', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @denarabot`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
`
 ...
 denara 𝐵𝑜𝑡𝑧☕︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       titid =  `SILAHKAN PILIH DI BAWAH UNTUK MELANJUTKAN`
                   ...
                   sendButMessage(from, titid, `crated denara 𝐵𝑜𝑡𝑧☕︎`, [
          {
            buttonId: `Y`,
            buttonText: {
              displayText: `Y`,
...
*「 denara 𝐵𝑜𝑡𝑧☕︎ 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Mendaftar Di Denara bot🐟*`)
		}, 2000)
        break
case 'sfire':
{
...
`
  buttons = [{buttonId: `${prefix}buypremium`,buttonText:{displayText: `Premium`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'denara 𝐵𝑜𝑡𝑧☕︎ ', imageMessage: imageMsg,
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*「 Denara Broadcast 」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
ikyy.sendMessage(_.jid, 
			{"contentText": `*「 Denara Broadcast 」*\n\n${body.slice(4)}`,
			"footerText": 'denara 𝑏𝑜𝑡𝑧 ㌹',
			"buttons": [
			{"buttonId": `#command`,
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://instagram.com/cal_me_Denara?utm_medium=copy_link`)
             break
      case 'hamdeh':
             reply('Hamdeh hamdeh')
             break
